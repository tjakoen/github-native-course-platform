...
export const OPS = [
  ...
  { file: "template-visibility.yml", note: "ORG-WIDE, not section-scoped: one template repo serves every class in the org. Refuses any repo that is not a template, solution or demo.", label: "Template visibility", group: "Content",
    desc: "Flip an activity template or solution repo between public (released) and private. The board is under Templates.",
    inputs: [
      { name: "repo", type: "string", def: "", required: true, hint: "repo names, comma separated" },
      { name: "visibility", type: "choice", options: ["public", "private"], def: "public" },
      { name: "mode", type: "choice", options: ["dry-run", "execute"], def: "dry-run", gate: "execute", danger: "change repo visibility for the whole org" },
      { name: "allow_solution_public", type: "bool", def: "false", hint: "required to expose a worked solution" },
    ] },
